...
OrderDetialWidget::OrderDetialWidget( QString strOrderCode, QWidget *parent)
	: QWidget(parent)
...
OrderDetialWidget::~OrderDetialWidget()
{
}


void OrderDetialWidget::mousePressEvent(QMouseEvent *event)
{
	if (!isMaximized())
	{
...
void OrderDetialWidget::mouseMoveEvent(QMouseEvent *event)
{
	if (!isMaximized())
	{
