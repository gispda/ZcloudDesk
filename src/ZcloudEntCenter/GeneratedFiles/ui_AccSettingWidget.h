/********************************************************************************
** Form generated from reading UI file 'AccSettingWidget.ui'
**
...
#ifndef UI_ACCSETTINGWIDGET_H
#define UI_ACCSETTINGWIDGET_H
...
public:
    ...
    void setupUi(QWidget *AccSettingWidget)
    {
        if (AccSettingWidget->objectName().isEmpty())
            AccSettingWidget->setObjectName(QStringLiteral("AccSettingWidget"));
        AccSettingWidget->resize(800, 500);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(AccSettingWidget->sizePolicy().hasHeightForWidth());
        AccSettingWidget->setSizePolicy(sizePolicy);
        AccSettingWidget->setMinimumSize(QSize(800, 500));
        AccSettingWidget->setMaximumSize(QSize(800, 500));
        AccSettingWidget->setStyleSheet(QStringLiteral("QWidget#AccSettingWidget{background-color: rgb(255, 255, 255);border-radius:8px;}"));
        TopWidget = new QWidget(AccSettingWidget);
...
"QPushButton:hover,pressed{border-image: url(:/EntCenterWidget/image/close_sel.png);};"));
        labelFirstName = new QLabel(AccSettingWidget);
        labelFirstName->setObjectName(QStringLiteral("labelFirstName"));
        labelFirstName->setGeometry(QRect(40, 73, 60, 60));
        ...
        label = new QLabel(AccSettingWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(119, 81, 61, 14));
...
"color: #666666;\n"
"border-bottom:0px;"));
        labelUserName = new QLabel(AccSettingWidget);
        labelUserName->setObjectName(QStringLiteral("labelUserName"));
        labelUserName->setGeometry(QRect(190, 81, 321, 15));
...
"color: #666666;\n"
"border-bottom:0px;"));
        label_2 = new QLabel(AccSettingWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(119, 109, 35, 14));
...
"color: #666666;\n"
"border-bottom:0px;"));
        labelTrueName = new QLabel(AccSettingWidget);
        labelTrueName->setObjectName(QStringLiteral("labelTrueName"));
        labelTrueName->setGeometry(QRect(160, 109, 240, 15));
...
"color: #666666;\n"
"border-bottom:0px;"));
        labelJob = new QLabel(AccSettingWidget);
        labelJob->setObjectName(QStringLiteral("labelJob"));
        labelJob->setGeometry(QRect(450, 109, 230, 15));
...
"color: #666666;\n"
"border-bottom:0px;"));
        label_3 = new QLabel(AccSettingWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(409, 109, 35, 14));
...
"color: #666666;\n"
"border-bottom:0px;"));
        labelInfoEdit = new QLabel(AccSettingWidget);
        labelInfoEdit->setObjectName(QStringLiteral("labelInfoEdit"));
        labelInfoEdit->setGeometry(QRect(711, 96, 30, 14));
...
"color: #1E8BED;\n"
"border-bottom:0px;"));
        label_4 = new QLabel(AccSettingWidget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(30, 153, 740, 1));
        ...
        widgetPhone = new QWidget(AccSettingWidget);
        widgetPhone->setObjectName(QStringLiteral("widgetPhone"));
        widgetPhone->setGeometry(QRect(30, 174, 740, 60));
...
"color: #1E8BED;\n"
"border-bottom:0px;"));
        widgetPwd = new QWidget(AccSettingWidget);
        widgetPwd->setObjectName(QStringLiteral("widgetPwd"));
        widgetPwd->setGeometry(QRect(30, 254, 740, 60));
...
"color: #1E8BED;\n"
"border-bottom:0px;"));
        widgetEmail = new QWidget(AccSettingWidget);
        widgetEmail->setObjectName(QStringLiteral("widgetEmail"));
        widgetEmail->setGeometry(QRect(30, 334, 740, 60));
...
"color: #1E8BED;\n"
"border-bottom:0px;"));
        widgetAddr = new QWidget(AccSettingWidget);
        widgetAddr->setObjectName(QStringLiteral("widgetAddr"));
        widgetAddr->setGeometry(QRect(30, 414, 740, 60));
...
"border-bottom:0px;"));
        ...
        retranslateUi(AccSettingWidget);

        QMetaObject::connectSlotsByName(AccSettingWidget);
    } // setupUi

    void retranslateUi(QWidget *AccSettingWidget)
    {
        AccSettingWidget->setWindowTitle(QApplication::translate("AccSettingWidget", "AccSettingWidget", 0));
        labelTitle->setText(QApplication::translate("AccSettingWidget", "\350\264\246\345\217\267\350\256\276\347\275\256", 0));
        closeButton->setText(QString());
        labelFirstName->setText(QString());
        label->setText(QApplication::translate("AccSettingWidget", "\347\231\273\345\275\225\350\264\246\345\217\267\357\274\232", 0));
        labelUserName->setText(QString());
        label_2->setText(QApplication::translate("AccSettingWidget", "\345\247\223\345\220\215\357\274\232", 0));
        labelTrueName->setText(QString());
        labelJob->setText(QString());
        label_3->setText(QApplication::translate("AccSettingWidget", "\350\201\214\345\212\241\357\274\232", 0));
        labelInfoEdit->setText(QApplication::translate("AccSettingWidget", "\344\277\256\346\224\271", 0));
        label_4->setText(QString());
        label_5->setText(QApplication::translate("AccSettingWidget", "\346\211\213\346\234\272\347\273\221\345\256\232", 0));
        labelPhone->setText(QString());
        labelPhoneIcon->setText(QString());
        labelPhone1->setText(QString());
        label_6->setText(QString());
        labelPhone2->setText(QString());
        label_7->setText(QApplication::translate("AccSettingWidget", "\347\231\273\345\275\225\345\257\206\347\240\201", 0));
        labelPwd->setText(QString());
        labelPwdIcon->setText(QString());
        labelPwd1->setText(QString());
        label_8->setText(QString());
        labelPwd2->setText(QString());
        label_9->setText(QApplication::translate("AccSettingWidget", "\351\202\256\347\256\261\347\273\221\345\256\232", 0));
        labelEmail->setText(QString());
        labelEmailIcon->setText(QString());
        labelEmail1->setText(QString());
        label_10->setText(QString());
        labelEmail2->setText(QString());
        label_11->setText(QApplication::translate("AccSettingWidget", "\346\224\266\350\264\247\345\234\260\345\235\200", 0));
...
namespace Ui {
    class AccSettingWidget: public Ui_AccSettingWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ACCSETTINGWIDGET_H
