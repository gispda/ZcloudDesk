/********************************************************************************
** Form generated from reading UI file 'EntAppealDlg.ui'
**
...
#ifndef UI_ENTAPPEALDLG_H
#define UI_ENTAPPEALDLG_H
...
public:
    ...
    void setupUi(QDialog *EntAppealDlg)
    {
        if (EntAppealDlg->objectName().isEmpty())
            EntAppealDlg->setObjectName(QStringLiteral("EntAppealDlg"));
        EntAppealDlg->resize(366, 296);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(EntAppealDlg->sizePolicy().hasHeightForWidth());
        EntAppealDlg->setSizePolicy(sizePolicy);
        EntAppealDlg->setMinimumSize(QSize(366, 296));
        EntAppealDlg->setMaximumSize(QSize(3660, 2960));
        verticalLayout = new QVBoxLayout(EntAppealDlg);
        verticalLayout->setSpacing(0);
        verticalLayout->setContentsMargins(11, 11, 11, 11);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(8, 8, 8, 8);
        FilletWidget = new QWidget(EntAppealDlg);
...
"}"));
        ...
        labelUpload->setStyleSheet(QStringLiteral("border-radius:4px;color:rgba(51,51,51,1);border:1px solid rgb(222,222,222);font:18px 'Microsoft Yahei';"));
        labelLicense->raise();
        labelTilte->raise();
        BtnWidget1->raise();
        ...
        retranslateUi(EntAppealDlg);
        QObject::connect(clostPushButton, SIGNAL(clicked()), EntAppealDlg, SLOT(reject()));

        QMetaObject::connectSlotsByName(EntAppealDlg);
    } // setupUi

    void retranslateUi(QDialog *EntAppealDlg)
    {
        EntAppealDlg->setWindowTitle(QApplication::translate("EntAppealDlg", "MessageTipDlg", 0));
        labelTilte->setText(QApplication::translate("EntAppealDlg", "\350\257\267\344\270\212\344\274\2408M\344\273\245\345\206\205\357\274\214JPG/PNG\346\240\274\345\274\217\347\232\204\350\220\245\344\270\232\346\211\247\347\205\247\345\233\276\347\211\207", 0));
        buttonOK->setText(QApplication::translate("EntAppealDlg", "\346\217\220\344\272\244", 0));
        clostPushButton->setText(QString());
        label->setText(QApplication::translate("EntAppealDlg", "\344\270\212\344\274\240\350\220\245\344\270\232\346\211\247\347\205\247", 0));
        labelLicense->setText(QString());
        labelUpload->setText(QApplication::translate("EntAppealDlg", "\344\270\212\344\274\240\345\233\276\347\211\207", 0));
    } // retranslateUi

};

namespace Ui {
    class EntAppealDlg: public Ui_EntAppealDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ENTAPPEALDLG_H
