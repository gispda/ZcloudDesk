...
"border:1px solid rgba(226,226,226,1);"));
        toolButton = new QToolButton(ZcloudLoginTip);
        toolButton->setObjectName(QStringLiteral("toolButton"));
        toolButton->setGeometry(QRect(193, 332, 100, 38));
        toolButton->setStyleSheet(QString::fromUtf8("QToolButton{background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(2, 164, 253, 1), stop:1 rgba(31, 139, 237, 1));border-radius:4px;font: 14px \"\345\276\256\350\275\257\351\233\205\351\273\221\";color:rgba(255, 255, 255, 1);padding-left:8px;}\n"
...
"line-height:20px;"));
    ...
    void retranslateUi(QWidget *ZcloudLoginTip)
    {
        ...
        toolButton->setText(QApplication::translate("ZcloudLoginTip", "\347\253\213\345\210\273\347\231\273\351\231\206", 0));
        closeButton->setText(QApplication::translate("ZcloudLoginTip", "\347\253\213\345\210\273\347\231\273\351\231\206", 0));
