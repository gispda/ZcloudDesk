...
public:
    ...
    void setupUi(QDialog *MessageTipDlg)
    {
        ...
        MessageTipDlg->setMaximumSize(QSize(366, 296));
        ...
        FilletWidget->setMaximumSize(QSize(350, 280));
...
"background-color: rgb(255, 255, 255);"));
        ...
        labelIcon->setStyleSheet(QStringLiteral("border-image: url(:/ZcloudDeskUpdater/Resources/msgTip.png);"));
