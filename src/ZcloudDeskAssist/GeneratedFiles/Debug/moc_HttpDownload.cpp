...
QT_MOC_LITERAL(1, 13, 19), // "sigDownloadProgress"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 11) // "onReadyRead"

    },
    "HttpDownload\0sigDownloadProgress\0\0"
    "onReadyRead"
};
...
void HttpDownload::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigDownloadProgress((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        ...
        {
            typedef void (HttpDownload::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpDownload::sigDownloadProgress)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject HttpDownload::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpDownload.data,
      qt_meta_data_HttpDownload,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void HttpDownload::sigDownloadProgress(qint64 _t1, qint64 _t2)
{
